...
public class PdfInvoiceController {
    ...
    @PostMapping("/upload-and-transmit")
    public ResponseEntity<String> uploadAndTransmit(@RequestParam("file") MultipartFile file) {
        try {
            ...
            List<InvoiceBean> invoices = pdfInvoiceService.extractAndConvertToInvoiceBean(file);
    ...
    @PostMapping("/upload-multiple-and-transmit")
