...
//    private static final String BASE_URL = "http://41.222.103.118:22221";
    ...
    public void scheduledInvoiceProcessing() {
        ...
        downloadAndSubmitInvoices("bills"); // ✅ correct folder name
    }
        ...
        try {
            ...
            for (Map<String, Object> file : files) {
                ...
                if (downloaded != null) {
                    ...
                    if (isSuccess) {
                        System.out.println("✅ Submitted Successfully bills . Moving file.");
    ...
    public static void main(String[] args) {
        ...
        try {
            service.downloadAndSubmitInvoices("bills"); // ✅ correct endpoint path
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
