...
import com.mra.Util.RechargePdfExtractor;
...
public class RechargeService {
    ...
    public List<InvoiceBean> extractAndConvertToInvoiceBean(MultipartFile file) throws Exception {
        JsonNode jsonNode = RechargePdfExtractor.convertPdfToJson(file);
        ObjectMapper mapper = new ObjectMapper();
        System.out.println("jons node value :"+jsonNode);
    ...
    public void processInvoicesHourly() {
        File folder = new File("/home/inovice/Recharge/");

//        File folder = new File("C:\\Users\\Krishna Purohit\\Downloads\\invoice\\invoice\\Recharge");
        ...
        if (files == null || files.length == 0) {
            System.out.println("No files found to process. for Recharges PDF Scanning");
            return;
        }
